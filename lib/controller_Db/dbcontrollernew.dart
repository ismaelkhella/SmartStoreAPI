...
class DbControllerproduct{
  static final DbControllerproduct _DbController= new DbControllerproduct._internal();
  DbControllerproduct._internal();
  late Database _database;
  Database get database=> _database;
  factory DbControllerproduct(){
